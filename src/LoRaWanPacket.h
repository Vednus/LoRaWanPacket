...
class LoRaWanPacketClass : public Stream {
   public:
    ...
    void personalize(const char *_devAddr, const char *_nwkSKey,
                     const char *_appSKey);
    ...
    void setJoinValuesFromRTC(uint8_t *_deui, uint8_t *_aeui, uint8_t *_akey,
                              uint8_t *_daddr, uint8_t *_nwkSKey,
                              uint8_t *_appSKey, uint32_t _frameCount,
                              uint32_t _frameCountDown, uint8_t _FPort,
                              uint8_t _FCtrl, uint8_t _lastMac);
